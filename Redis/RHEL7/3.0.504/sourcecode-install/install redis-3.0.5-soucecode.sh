...
#use yum localinstall to install the rpm download
yum localinstall -y cpp-4.8.5-11.el7.x86_64.rpm gcc-4.8.5-11.el7.x86_64.rpm glibc-2.17-157.el7_3.2.x86_64.rpm glibc-common-2.17-157.el7_3.2.x86_64.rpm glibc-devel-2.17-157.el7_3.2.x86_64.rpm glibc-headers-2.17-157.el7_3.2.x86_64.rpm kernel-headers-3.10.0-514.21.1.el7.x86_64.rpm libgcc-4.8.5-11.el7.x86_64.rpm libgomp-4.8.5-11.el7.x86_64.rpm libmpc-1.0.1-3.el7.x86_64.rpm
